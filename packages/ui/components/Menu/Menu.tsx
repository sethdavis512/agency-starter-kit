...
>(({ className, ...props }, ref) => (
    <Menu.Trigger
        ref={ref}
        className={cn(
            'inline-flex h-8 cursor-default items-center gap-1 rounded-sm px-3 text-sm font-medium text-neutral select-none outline-none',
...
>(({ className, ...props }, ref) => (
    <Menu.Popup
        ref={ref}
        className={cn(
            'min-w-[8rem] rounded-md border border-neutral/15 bg-surface p-1 shadow-md',
...
const itemClasses =
    'relative flex cursor-default items-center gap-2 rounded-sm px-3 py-1.5 text-sm text-neutral select-none outline-none ' +
    'data-highlighted:bg-muted/60 data-popup-open:bg-muted/40 ' +
...
>(({ className, ...props }, ref) => (
    <Menu.Separator
        ref={ref}
        className={cn('my-1 h-px bg-neutral/10', className)}
        {...props}
    />
));
...
>(({ className, ...props }, ref) => (
    <Menu.GroupLabel
        ref={ref}
        className={cn(
            'px-3 py-1 text-xs font-semibold tracking-wide text-neutral/50',
            className
        )}
        {...props}
    />
