...
>(({ className, ...props }, ref) => (
  <BaseTooltip.Trigger
    ref={ref}
    className={cn(
      "inline-flex items-center justify-center rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <BaseTooltip.Popup
    ref={ref}
    className={cn(
      "origin-[var(--transform-origin)] rounded-md bg-neutral-solid px-2.5 py-1.5 text-xs font-medium text-white shadow-sm transition-[transform,opacity] duration-150 data-ending-style:scale-90 data-ending-style:opacity-0 data-instant:transition-none data-starting-style:scale-90 data-starting-style:opacity-0",
      className,
    )}
    {...props}
  />
