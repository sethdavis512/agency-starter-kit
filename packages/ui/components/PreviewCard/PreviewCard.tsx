...
>(({ className, ...props }, ref) => (
    <BasePreviewCard.Trigger
        ref={ref}
        className={cn(
            'text-primary underline decoration-primary/60 decoration-1 underline-offset-2 outline-none hover:decoration-primary focus-visible:rounded-sm focus-visible:no-underline focus-visible:outline-2 focus-visible:outline-offset-1 focus-visible:outline-primary data-popup-open:decoration-primary',
            className
        )}
        {...props}
    />
...
>(({ className, ...props }, ref) => (
    <BasePreviewCard.Popup
        ref={ref}
        className={cn(
            'origin-[var(--transform-origin)] rounded-lg border border-neutral/15 bg-surface text-neutral shadow-lg transition-[transform,opacity] duration-150 data-ending-style:scale-95 data-ending-style:opacity-0 data-starting-style:scale-95 data-starting-style:opacity-0',
            className
        )}
        {...props}
    />
