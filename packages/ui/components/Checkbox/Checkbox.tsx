...
>(({ className, ...props }, ref) => (
    <BaseCheckbox.Root
        ref={ref}
        className={cn(
            'flex size-5 shrink-0 items-center justify-center rounded-sm border border-neutral/30 bg-surface transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 data-checked:border-primary data-checked:bg-primary data-indeterminate:border-primary data-indeterminate:bg-primary data-disabled:cursor-not-allowed data-disabled:opacity-50',
            className
        )}
        {...props}
    />
