...
>(({ className, ...props }, ref) => (
    <Progress.Label
        ref={ref}
        className={cn('text-sm font-medium text-neutral', className)}
        {...props}
    />
));
...
>(({ className, ...props }, ref) => (
    <Progress.Track
        ref={ref}
        className={cn(
            'h-2 w-full overflow-hidden rounded-full bg-neutral/15',
            className
        )}
        {...props}
    />
...
>(({ className, ...props }, ref) => (
    <Progress.Indicator
        ref={ref}
        className={cn(
            'h-full bg-primary transition-[width] duration-300 ease-in-out data-[status=indeterminate]:w-1/3 data-[status=indeterminate]:animate-[slide-in_1.5s_ease-in-out_infinite]',
            className
        )}
        {...props}
    />
