...
export const alertVariants = cva({
  ...
  variants: {
    variant: {
      ...
      warning:
        "border-l-secondary bg-secondary/8 text-neutral dark:bg-secondary/15 dark:text-secondary",
      error:
        "border-l-danger bg-danger/8 text-neutral dark:bg-danger/15 dark:text-danger",
