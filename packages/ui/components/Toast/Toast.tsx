...
>(({ className, ...props }, ref) => (
    <Toast.Root
        ref={ref}
        className={cn(
            'group relative flex w-full items-start gap-3 rounded-xl border border-neutral/15 bg-surface p-4 shadow-lg shadow-neutral/10',
...
>(({ className, ...props }, ref) => (
    <Toast.Title
        ref={ref}
        className={cn('text-sm font-semibold text-neutral', className)}
        {...props}
    />
));
...
>(({ className, children, ...props }, ref) => (
    <Toast.Close
        ref={ref}
        className={cn(
            'absolute right-3 top-3 flex h-6 w-6 items-center justify-center rounded-md text-neutral/40 transition-colors hover:text-neutral focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary',
            className
        )}
        {...props}
    >
...
>(({ className, ...props }, ref) => (
    <Toast.Action
        ref={ref}
        className={cn(
            'mt-1 inline-flex h-7 items-center rounded-md border border-neutral/20 bg-transparent px-2.5 text-xs font-medium text-neutral transition-colors hover:bg-muted/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary',
            className
        )}
        {...props}
    />
