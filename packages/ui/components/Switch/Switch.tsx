...
>(({ className, ...props }, ref) => (
    <BaseSwitch.Root
        ref={ref}
        className={cn(
            'relative flex h-6 w-10 cursor-pointer rounded-full border border-neutral/20 bg-neutral/20 p-0.5 transition-colors duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 data-checked:border-primary data-checked:bg-primary data-disabled:cursor-not-allowed data-disabled:opacity-50',
            className
        )}
        {...props}
    />
