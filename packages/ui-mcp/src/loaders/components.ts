...
import { UI_PACKAGE_JSON_PATH, UI_PACKAGE_PATH } from "../constants.js";
 ...
 */
async function resolveSourceFile(exportValue: string): Promise<string | null> {
